...
let Barry = function() {
  this.intents = {
    ...
    'apologise': ['Ging dit te ver [name]?', 'Kon je het niet aan?', 'Excuus, ik had rekening moeten houden met het niveau wat jij kunt begrijpen'],
...
Barry.prototype.listen = async function(msg) {
  ...
  if (!text.includes(' barry') && !text.includes('barry ')) return;
